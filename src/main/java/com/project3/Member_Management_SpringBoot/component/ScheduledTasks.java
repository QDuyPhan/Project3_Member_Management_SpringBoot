...
public class ScheduledTasks {
    ...
    // List<Discipline> dueTwoMonth = disciplineService.findDueTwoMonth(currenTime);
    // for (Discipline dl : dueTwoMonth) {
    // disciplineService.updateStatus(dl.getId(), dl.getStatus());
    // }
    ...
    // }
    @Scheduled(cron = "0 0 * * * *") // Chạy vào phút 0 mỗi giờ
    public void scheduledTask() {
        disciplineService.updateStatusAfterTwoMonths();
    }

    @Scheduled(cron = "0 0 0 1 * *") // Chạy vào đầu mỗi tháng
    public void updateStatusAfterOneMonth() {
        disciplineService.updateStatusAfterOneMonth();
    }
}
