...
public interface UsageRepository extends CrudRepository<Usage, Integer> {
        ...
        List<Usage> statisticsMember(@Param("department") String department, @Param("major") String major,
        ...
        List<Usage> statisticsBorrowedDevice(@Param("name") String name, @Param("startDate") Timestamp startDate,
        ...
        List<Usage> statisticsBorrowingDevice(@Param("startDate") Timestamp startDate,
                        @Param("endDate") Timestamp endDate);
}
